...
C_SRCS += \
../Core/Src/HAL_I2C_anklabs.c \
../Core/Src/HTS221_anklabs.c \
../Core/Src/main.c \
...
OBJS += \
./Core/Src/HAL_I2C_anklabs.o \
./Core/Src/HTS221_anklabs.o \
./Core/Src/main.o \
...
C_DEPS += \
./Core/Src/HAL_I2C_anklabs.d \
./Core/Src/HTS221_anklabs.d \
./Core/Src/main.d \
...
Core/Src/HAL_I2C_anklabs.o: ../Core/Src/HAL_I2C_anklabs.c Core/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32L151xE -c -I../Core/Inc -I../Drivers/STM32L1xx_HAL_Driver/Inc -I../Drivers/STM32L1xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32L1xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/HAL_I2C_anklabs.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
Core/Src/HTS221_anklabs.o: ../Core/Src/HTS221_anklabs.c Core/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32L151xE -c -I../Core/Inc -I../Drivers/STM32L1xx_HAL_Driver/Inc -I../Drivers/STM32L1xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32L1xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/HTS221_anklabs.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
